                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-item-content">
                                <div class="blog-item-meta mb-3 mt-4">
                                    ...
                                    <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-1"></i> {{$artikel -> created_at}}</span>
                                </div>

                                <h2 class="mt-3 mb-3"><a href="blog-single.html">{{$artikel -> judul}}</a></h2>

                                <p class="mb-4">{{$artikel -> headline}}</p>

                                <a href="{{route('artikel.show',['artikel'=>$artikel->id])}}" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
