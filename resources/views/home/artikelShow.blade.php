                        ...
                        <div class="single-blog-item">
                            ...
                            <div class="blog-item-content mt-5">
                                <div class="blog-item-meta mb-3">
                                    ...
                                    <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-2"></i> {{$artikels->created_at}}</span>
                                </div>

                                <h2 class="mb-4 text-md"><a href="blog-single.html">{{$artikels->judul}}</a></h2>

                                <p class="lead mb-4">{{$artikels->headline}}</p>
